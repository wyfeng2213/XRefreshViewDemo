 ...
 */
package com.example.administrator.xrefreshviewdemo.listviewletter;
 ...
 */
public class ListviewLetterActivity extends KJActivity implements SideBar
    ...
    public static void startActivity(Context context) {
        Intent starter = new Intent(context, ListviewLetterActivity.class);
//        starter.putExtra();
