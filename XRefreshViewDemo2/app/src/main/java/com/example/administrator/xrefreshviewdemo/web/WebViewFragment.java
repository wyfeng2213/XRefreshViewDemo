...
//    webViewFragment.addWebViewURL(webViewFragment, "http://www.baidu.com");
    ...
    //添加webview的Url参数
    public void addWebViewURL(com.cmcc.healthlibrary.view.WebViewFragment webViewFragment, String url) {
        Bundle args = new Bundle();
        args.putString(com.cmcc.healthlibrary.view.WebViewFragment.KEY_URL, url);
