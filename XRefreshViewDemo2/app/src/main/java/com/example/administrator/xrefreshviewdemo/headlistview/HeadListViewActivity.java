package com.example.administrator.xrefreshviewdemo.headlistview;
...
public class HeadListViewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listview.setOnChildClickListener(new ExpandableListView.OnChildClickListener() {
            ...
            public boolean onChildClick(ExpandableListView expandableListView, View view, int i, int i1, long l) {
                Toast.makeText(HeadListViewActivity.this, "点击了第" + (i + 1) + " 类的第" + i1 + "项", Toast.LENGTH_SHORT).show();
                return true;
            }
        });
    ...
    public static void startActivity(Context context) {
        Intent starter = new Intent(context, HeadListViewActivity.class);
//        starter.putExtra();
