...
public class EditTextCount extends RelativeLayout {
     ...
     * @return
     */
    public EditTextCount setLineColor(String color) {
     ...
     * @return
     */
    public EditTextCount setLineColor(int color) {
     ...
     * @return
     */
    public EditTextCount setType(String type) {
        TYPES = type;
        return this;
    }
     ...
     * @return
     */
    public EditTextCount setLength(int num) {
        this.MaxNum = num;
        return this;
    }
     ...
     * @return
     */
    public EditTextCount setEtMinHeight(int px) {
     ...
     * @return
     */
    public EditTextCount setEtMinLines(int lines) {
    ...
    public EditTextCount setLeftCountVisible(int visible) {
