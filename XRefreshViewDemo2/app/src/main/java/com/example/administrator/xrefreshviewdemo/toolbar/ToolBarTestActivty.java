...
public class ToolBarTestActivty extends AppCompatActivity implements Toolbar.OnMenuItemClickListener  {


    public static void startActivity(Context context) {
        Intent starter = new Intent(context, ToolBarTestActivty.class);
//        starter.putExtra();
